          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              <li class="user-header">
                <img src="{{ asset('public/backend/images/user/'.Auth::User()['user_image']) }}" class="img-circle" alt="User Image">

                <p>

                  {{ Auth::User()['user_fullname'] }}
                  <small>Member since {{ Auth::User()['birthday'] }}</small>
                </p>
              </li>
              <li class="user-body">
                <div class="row">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{ route('name-backend-logout') }}" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
            </li>
